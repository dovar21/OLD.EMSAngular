...
import {DictionaryNationalitiesFetchCriterias, DictionaryNationalitiesService} from '../dictionary-nationalities.service';
import {DictionaryNationalitiesCreateUpdateComponent} from '../dictionary-nationalities-create-update/dictionary-nationalities-create-update.component';
import { DictionaryNationalitiesFilterComponent } from '../dictionary-nationalities-filter/dictionary-nationalities-filter.component';
import { AppComponent } from '../../../../app.component';

@Component({
    selector: 'dictionary-nationalities-list-component',
    templateUrl: './dictionary-nationalities-list.component.html',
    styleUrls: ['./dictionary-nationalities-list.component.sass'],
    animations: [fade]
})
export class DictionaryNationalitiesListComponent implements OnInit, OnDestroy {
     ...
     */
    nationalities = new MatTableDataSource();

    /**
     * Total number of dictionary-nationalities in DB.
     */
    totalCount: number;
    ...
    /**
     * Number of dictionary-nationalities to show on one page.
     */
    pageSize: number;
     ...
     * to be sent to API.
     */
    fetchCriterias: DictionaryNationalitiesFetchCriterias;
    ...
    ngOnInit() {
        if (this.permissions['Nationalities.Details'] || this.permissions['Nationalities.Edit'])
        ...
        // Set paginator values if nationality navigated from paginated link
        ...
        this.route.queryParams.pipe(takeUntil(componentDestroyed(this))).subscribe(params => {
            if (params.constructor === Object && Object.keys(params).length !== 0) {
                this.getNationalities(params);
            } else this.getNationalities();
        });
    }
    ...
    openBottomSheet(): void {
        this.bottomSheet.open(DictionaryNationalitiesFilterComponent);
    }
    ...
    openDialogUpdate(id?: number, name?: string): void {
        const dialogRef = this.dialog.open(DictionaryNationalitiesCreateUpdateComponent, {
            data: { id, name }
        });
        ...
        dialogRef
            ...
            .subscribe(result => {
                if (result === 'submit') this.getNationalities();
            });
    }
    ...
    /**
     * Send search criterias to nationalitiesService and get dictionary-nationalities
     * list in return
     * @param criterias Fetch criterias for DB searching
     */
    private getNationalities(criterias?: DictionaryNationalitiesFetchCriterias) {
