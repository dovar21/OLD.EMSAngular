...
@Component({
    selector: 'dictionary-nationalities-filter-list',
    templateUrl: './dictionary-nationalities-filter-list.component.html',
    styleUrls: ['./dictionary-nationalities-filter-list.component.sass'],
})
export class DictionaryNationalitiesFilterListComponent implements OnInit, OnDestroy {
