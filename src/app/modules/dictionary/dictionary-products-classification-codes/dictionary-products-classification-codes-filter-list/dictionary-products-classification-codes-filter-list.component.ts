...
@Component({
    selector: 'dictionary-products-classification-codes-filter-list',
    templateUrl: './dictionary-products-classification-codes-filter-list.component.html',
    styleUrls: ['./dictionary-products-classification-codes-filter-list.component.sass'],
})
export class DictionaryProductsClassificationCodesFilterListComponent implements OnInit, OnDestroy {
