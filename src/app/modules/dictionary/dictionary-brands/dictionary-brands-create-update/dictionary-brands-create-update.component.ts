...
import {DictionaryBrand, DictionaryBrandsService} from '../dictionary-brands.service';

@Component({
    selector: 'dictionary-brands-create-update',
    templateUrl: './dictionary-brands-create-update.component.html',
    styleUrls: ['./dictionary-brands-create-update.component.sass']
})
export class DictionaryBrandsCreateUpdateComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<DictionaryBrandsCreateUpdateComponent>,
    ...
    getBrandsById() {
        ...
        this.service
            .getDictionaryBrandById(this.data.id)
