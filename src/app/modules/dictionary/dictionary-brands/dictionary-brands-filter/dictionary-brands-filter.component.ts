...
import { DictionaryBrandsFetchCriterias } from '../dictionary-brands.service';
...
@Component({
    selector: 'dictionary-brands-filter',
    templateUrl: './dictionary-brands-filter.component.html',
    styleUrls: ['./dictionary-brands-filter.component.sass'],
    animations: [fade]
})
export class DictionaryBrandsFilterComponent implements OnInit, OnDestroy {
    ...
    constructor(@Inject(MAT_BOTTOM_SHEET_DATA) bottomSheet: string,
                private _bottomSheetRef: MatBottomSheetRef<DictionaryBrandsFilterComponent>,
    ...
    submitFilter(isReset?: boolean) {
        ...
        const criterias: DictionaryBrandsFetchCriterias = this.form.value;
