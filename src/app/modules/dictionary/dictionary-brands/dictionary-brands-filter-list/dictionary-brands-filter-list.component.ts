...
@Component({
    selector: 'dictionary-brands-filter-list',
    templateUrl: './dictionary-brands-filter-list.component.html',
    styleUrls: ['./dictionary-brands-filter-list.component.sass'],
})
export class DictionaryBrandsFilterListComponent implements OnInit, OnDestroy {
