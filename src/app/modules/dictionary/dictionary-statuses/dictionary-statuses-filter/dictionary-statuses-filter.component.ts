...
import { DictionaryStatusesFetchCriterias } from '../dictionary-statuses.service';
...
@Component({
    selector: 'dictionary-statuses-filter',
    templateUrl: './dictionary-statuses-filter.component.html',
    styleUrls: ['./dictionary-statuses-filter.component.sass'],
    animations: [fade]
})
export class DictionaryStatusesFilterComponent implements OnInit, OnDestroy {
    ...
    constructor(@Inject(MAT_BOTTOM_SHEET_DATA) bottomSheet: string,
                private _bottomSheetRef: MatBottomSheetRef<DictionaryStatusesFilterComponent>,
    ...
    submitFilter(isReset?: boolean) {
        ...
        const criterias: DictionaryStatusesFetchCriterias = this.form.value;
