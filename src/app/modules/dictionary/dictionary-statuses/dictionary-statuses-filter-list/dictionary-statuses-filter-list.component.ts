...
@Component({
    selector: 'dictionary-statuses-filter-list',
    templateUrl: './dictionary-statuses-filter-list.component.html',
    styleUrls: ['./dictionary-statuses-filter-list.component.sass'],
})
export class DictionaryStatusesFilterListComponent implements OnInit, OnDestroy {
