...
@Component({
    selector: 'dictionary-employee-lock-reasons-filter-list',
    templateUrl: './dictionary-employee-lock-reasons-filter-list.component.html',
    styleUrls: ['./dictionary-employee-lock-reasons-filter-list.component.sass'],
})
export class DictionaryEmployeeLockReasonsFilterListComponent implements OnInit, OnDestroy {
