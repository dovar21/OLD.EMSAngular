...
@Component({
    selector: 'dictionary-files-categories-filter-list',
    templateUrl: './dictionary-files-categories-filter-list.component.html',
    styleUrls: ['./dictionary-files-categories-filter-list.component.sass'],
})
export class DictionaryFilesCategoriesFilterListComponent implements OnInit, OnDestroy {
