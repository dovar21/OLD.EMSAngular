...
import { DictionaryUnitsFetchCriterias, DictionaryUnitsService } from '../dictionary-units.service';
import { DictionaryUnitsCreateUpdateComponent } from '../dictionary-units-create-update/dictionary-units-create-update.component';
import { DictionaryUnitsFilterComponent } from '../dictionary-units-filter/dictionary-units-filter.component';
import { AppComponent } from '../../../../app.component';

@Component({
    selector: 'dictionary-units-list-component',
    templateUrl: './dictionary-units-list.component.html',
    styleUrls: ['./dictionary-units-list.component.sass'],
    animations: [fade]
})
export class DictionaryUnitsListComponent implements OnInit, OnDestroy {
     ...
     * Units values
     */
    units = new MatTableDataSource();

    /**
     * Total number of dictionary-units in DB.
     */
    totalCount: number;
    ...
    /**
     * Number of dictionary-units to show on one page.
     */
    pageSize: number;
     ...
     * to be sent to API.
     */
    fetchCriterias: DictionaryUnitsFetchCriterias;
    ...
    ngOnInit() {
        if (this.permissions['Units.Details'] || this.permissions['Units.Edit'])
        ...
        // Set paginator values if unit navigated from paginated link
    ...
    openBottomSheet(): void {
        this.bottomSheet.open(DictionaryUnitsFilterComponent);
    }
    ...
    openDialogUpdate(id?: number, name?: string): void {
        const dialogRef = this.dialog.open(DictionaryUnitsCreateUpdateComponent, {
            data: { id, name }
        });
        ...
        dialogRef
            ...
            .subscribe(result => {
                if (result === 'submit') this.getUnits();
            });
    }
    ...
    /**
     * Send search criterias to unitsService and get dictionary-units
     * list in return
     * @param criterias Fetch criterias for DB searching
     */
    private getUnits(criterias?: DictionaryUnitsFetchCriterias) {
