...
@Component({
    selector: 'dictionary-units-filter-list',
    templateUrl: './dictionary-units-filter-list.component.html',
    styleUrls: ['./dictionary-units-filter-list.component.sass'],
})
export class DictionaryUnitsFilterListComponent implements OnInit, OnDestroy {
