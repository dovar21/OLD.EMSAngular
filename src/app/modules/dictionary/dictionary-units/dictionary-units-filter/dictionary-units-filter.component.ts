...
import { DictionaryUnitsFetchCriterias } from '../dictionary-units.service';
...
@Component({
    selector: 'dictionary-units-filter',
    templateUrl: './dictionary-units-filter.component.html',
    styleUrls: ['./dictionary-units-filter.component.sass'],
    animations: [fade]
})
export class DictionaryUnitsFilterComponent implements OnInit, OnDestroy {
    ...
    constructor(@Inject(MAT_BOTTOM_SHEET_DATA) bottomSheet: string,
                private _bottomSheetRef: MatBottomSheetRef<DictionaryUnitsFilterComponent>,
    ...
    submitFilter(isReset?: boolean) {
        ...
        const criterias: DictionaryUnitsFetchCriterias = this.form.value;
