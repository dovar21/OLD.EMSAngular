...
import { DictionaryUserLockReasonsFetchCriterias } from '../dictionary-user-lock-reasons.service';
...
@Component({
    selector: 'dictionary-user-lock-reasons-filter',
    templateUrl: './dictionary-user-lock-reasons-filter.component.html',
    styleUrls: ['./dictionary-user-lock-reasons-filter.component.sass'],
    animations: [fade]
})
export class DictionaryUserLockReasonsFilterComponent implements OnInit, OnDestroy {
    ...
    constructor(@Inject(MAT_BOTTOM_SHEET_DATA) bottomSheet: string,
                private _bottomSheetRef: MatBottomSheetRef<DictionaryUserLockReasonsFilterComponent>,
    ...
    submitFilter(isReset?: boolean) {
        ...
        const criterias: DictionaryUserLockReasonsFetchCriterias = this.form.value;
