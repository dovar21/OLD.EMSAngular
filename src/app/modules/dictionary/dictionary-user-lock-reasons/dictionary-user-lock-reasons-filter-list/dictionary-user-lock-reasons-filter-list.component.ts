...
@Component({
    selector: 'dictionary-user-lock-reasons-filter-list',
    templateUrl: './dictionary-user-lock-reasons-filter-list.component.html',
    styleUrls: ['./dictionary-user-lock-reasons-filter-list.component.sass'],
})
export class DictionaryUserLockReasonsFilterListComponent implements OnInit, OnDestroy {
