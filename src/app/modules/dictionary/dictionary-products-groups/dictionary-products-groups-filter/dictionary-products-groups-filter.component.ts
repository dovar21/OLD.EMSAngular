...
import { DictionaryProductGroupsFetchCriterias } from '../dictionary-product-groups.service';
...
@Component({
    selector: 'dictionary-products-groups-filter',
    templateUrl: './dictionary-products-groups-filter.component.html',
    styleUrls: ['./dictionary-products-groups-filter.component.sass'],
    animations: [fade]
})
export class DictionaryProductsGroupsFilterComponent implements OnInit, OnDestroy {
    ...
    constructor(@Inject(MAT_BOTTOM_SHEET_DATA) bottomSheet: string,
                private _bottomSheetRef: MatBottomSheetRef<DictionaryProductsGroupsFilterComponent>,
    ...
    submitFilter(isReset?: boolean) {
        ...
        const criterias: DictionaryProductGroupsFetchCriterias = this.form.value;
