...
@Component({
    selector: 'dictionary-products-groups-filter-list',
    templateUrl: './dictionary-products-groups-filter-list.component.html',
    styleUrls: ['./dictionary-products-groups-filter-list.component.sass'],
})
export class DictionaryProductsGroupsFilterListComponent implements OnInit, OnDestroy {
