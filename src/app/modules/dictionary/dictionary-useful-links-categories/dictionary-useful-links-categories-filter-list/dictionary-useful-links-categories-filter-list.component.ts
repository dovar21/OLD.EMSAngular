...
@Component({
    selector: 'dictionary-useful-links-categories-filter-list',
    templateUrl: './dictionary-useful-links-categories-filter-list.component.html',
    styleUrls: ['./dictionary-useful-links-categories-filter-list.component.sass'],
})
export class DictionaryUsefulLinksCategoriesFilterListComponent implements OnInit, OnDestroy {
