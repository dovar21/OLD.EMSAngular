...
import { DictionaryUsefulLinksCategoriesFetchCriterias } from '../dictionary-useful-links-categories.service';
...
@Component({
    selector: 'dictionary-useful-links-categories-filter',
    templateUrl: './dictionary-useful-links-categories-filter.component.html',
    styleUrls: ['./dictionary-useful-links-categories-filter.component.sass'],
    animations: [fade]
})
export class DictionaryUsefulLinksCategoriesFilterComponent implements OnInit, OnDestroy {
    ...
    constructor(@Inject(MAT_BOTTOM_SHEET_DATA) bottomSheet: string,
                private _bottomSheetRef: MatBottomSheetRef<DictionaryUsefulLinksCategoriesFilterComponent>,
    ...
    submitFilter(isReset?: boolean) {
        ...
        const criterias: DictionaryUsefulLinksCategoriesFetchCriterias = this.form.value;
