...
import { DepartmentsFetchCriterias } from '../dictionary-departments.service';
...
@Component({
    selector: 'dictionary-departments-filter',
    templateUrl: './dictionary-departments-filter.component.html',
    styleUrls: ['./dictionary-departments-filter.component.sass'],
    animations: [fade]
})
export class DictionaryDepartmentsFilterComponent implements OnInit, OnDestroy {
    ...
    constructor(@Inject(MAT_BOTTOM_SHEET_DATA) bottomSheet: string,
                private _bottomSheetRef: MatBottomSheetRef<DictionaryDepartmentsFilterComponent>,
    ...
    submitFilter(isReset?: boolean) {
        ...
        const criterias: DepartmentsFetchCriterias = this.form.value;
