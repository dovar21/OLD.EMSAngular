...
import { DictionaryDepartmentsCreateUpdateComponent } from '../dictionary-departments-create-update/dictionary-departments-create-update.component';
import { DictionaryDepartmentsFilterComponent } from '../dictionary-departments-filter/dictionary-departments-filter.component';
import { AppComponent } from '../../../../app.component';

@Component({
    selector: 'dictionary-departments-list-component',
    templateUrl: './dictionary-departments-list.component.html',
    styleUrls: ['./dictionary-departments-list.component.sass'],
    animations: [fade]
})
export class DictionaryDepartmentsListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        if (this.permissions['Departments.Details'] || this.permissions['Departments.Edit'])
    ...
    openBottomSheet(): void {
        this.bottomSheet.open(DictionaryDepartmentsFilterComponent);
    }
    ...
    openDialogUpdate(id?: number, name?: string): void {
        const dialogRef = this.dialog.open(DictionaryDepartmentsCreateUpdateComponent, {
            data: { id, name }
        });
        ...
        dialogRef
            ...
            .pipe(takeUntil(componentDestroyed(this)))
            .subscribe(result => {
                if (result === 'submit') this.getDepartments();
            });
    }
     ...
     */
    private getDepartments(criterias?: DepartmentsFetchCriterias) {
