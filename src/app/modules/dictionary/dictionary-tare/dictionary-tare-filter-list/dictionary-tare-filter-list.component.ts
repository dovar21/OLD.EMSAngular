...
@Component({
    selector: 'dictionary-tare-filter-list',
    templateUrl: './dictionary-tare-filter-list.component.html',
    styleUrls: ['./dictionary-tare-filter-list.component.sass'],
})
export class DictionaryTareFilterListComponent implements OnInit, OnDestroy {
