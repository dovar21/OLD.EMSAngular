...
import { DictionaryCountriesFetchCriterias } from '../dictionary-countries.service';
...
@Component({
    selector: 'dictionary-countries-filter',
    templateUrl: './dictionary-countries-filter.component.html',
    styleUrls: ['./dictionary-countries-filter.component.sass'],
    animations: [fade]
})
export class DictionaryCountriesFilterComponent implements OnInit, OnDestroy {
    ...
    constructor(@Inject(MAT_BOTTOM_SHEET_DATA) bottomSheet: string,
                private _bottomSheetRef: MatBottomSheetRef<DictionaryCountriesFilterComponent>,
    ...
    submitFilter(isReset?: boolean) {
        ...
        const criterias: DictionaryCountriesFetchCriterias = this.form.value;
