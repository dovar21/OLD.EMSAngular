...
import {DictionaryCountriesService, DictionaryCountry} from '../dictionary-countries.service';

@Component({
    selector: 'dictionary-countries-create-update',
    templateUrl: './dictionary-countries-create-update.component.html',
    styleUrls: ['./dictionary-countries-create-update.component.sass']
})
export class DictionaryCountriesCreateUpdateComponent implements OnInit, OnDestroy {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) public data: any,
                private dialogRef: MatDialogRef<DictionaryCountriesCreateUpdateComponent>,
    ...
    getCountriesById() {
        ...
        this.service
            .getDictionaryCountriesById(this.data.id)
