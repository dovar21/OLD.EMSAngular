...
@Component({
    selector: 'dictionary-countries-filter-list',
    templateUrl: './dictionary-countries-filter-list.component.html',
    styleUrls: ['./dictionary-countries-filter-list.component.sass'],
})
export class DictionaryCountriesFilterListComponent implements OnInit, OnDestroy {
